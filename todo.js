...
function AddTodo() {
    if (inpudata.value.length > 0) {
        ...
        if (checkdata) {
            ...
            img.src=( "https://img.icons8.com/ios-filled/30/edit--v1.png" )
            ...
            var img =document.createElement("img")
            img.src=( "https://img.icons8.com/pastel-glyph/30/loop.png" )
...
UpdateButton.appendChild(img)
            ...
            var img =document.createElement("img")
img.src=( "https://img.icons8.com/ios-glyphs/30/filled-trash.png" )
